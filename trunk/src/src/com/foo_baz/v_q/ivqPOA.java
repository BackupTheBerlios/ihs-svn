 ...
 implements com.foo_baz.v_q.ivqOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("eb_add", new java.lang.Integer (18));
    _methods.put ("eb_rm", new java.lang.Integer (19));
    _methods.put ("eb_ls", new java.lang.Integer (20));
    _methods.put ("user_conf_add", new java.lang.Integer (21));
    _methods.put ("user_conf_rm_by_type", new java.lang.Integer (22));
    _methods.put ("user_conf_rm", new java.lang.Integer (23));
    _methods.put ("user_conf_ls", new java.lang.Integer (24));
    _methods.put ("user_conf_ls_by_type", new java.lang.Integer (25));
    _methods.put ("user_conf_rep", new java.lang.Integer (26));
    _methods.put ("user_conf_get", new java.lang.Integer (27));
    _methods.put ("user_conf_type_has", new java.lang.Integer (28));
    _methods.put ("user_conf_type_cnt", new java.lang.Integer (29));
  }
  ...
  /// Removes all mailbox configuration entries
       case 22:  // vq/ivq/user_conf_rm_by_type
       {
         try {
           int dom_id = com.foo_baz.v_q.ivqPackage.id_typeHelper.read (in);
           String user = in.read_string ();
  ...
  /// Lists mailbox configuation of specified type
       case 25:  // vq/ivq/user_conf_ls_by_type
       {
         try {
           int dom_id = com.foo_baz.v_q.ivqPackage.id_typeHelper.read (in);
           String user = in.read_string ();
  ...
  /// Checks whether mailbox has entry of specified type
       case 28:  // vq/ivq/user_conf_type_has
       {
         try {
           int dom_id = com.foo_baz.v_q.ivqPackage.id_typeHelper.read (in);
           String user = in.read_string ();
  ...
  /// Counts entries of specified type
       case 29:  // vq/ivq/user_conf_type_cnt
       {
         try {
           int dom_id = com.foo_baz.v_q.ivqPackage.id_typeHelper.read (in);
           String user = in.read_string ();
