...
/**
* com/foo_baz/v_q/ivqPackage/user_info_listHelper.java .
...
{
  private static String  _id = "IDL:vq/ivq/user_info_list:1.0";
  ...
  public static com.foo_baz.v_q.ivqPackage.user_info[] read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value = new com.foo_baz.v_q.ivqPackage.user_info[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = com.foo_baz.v_q.ivqPackage.user_infoHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, com.foo_baz.v_q.ivqPackage.user_info[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      com.foo_baz.v_q.ivqPackage.user_infoHelper.write (ostream, value[_i0]);
  }
