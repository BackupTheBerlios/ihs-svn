...
public class Messages {
	public static FacesMessage getMessage( Class cls, String resourceId, Object [] params ) {
		return getMessage(cls.getClass().getName(), resourceId, params);
	}
	...
	public static String getString(Class cls, String resourceId, 
			Object[] params) {
		return getString(cls.getClass().getName(), resourceId, params);
	}
