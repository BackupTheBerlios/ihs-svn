...
/**
* com/foo_baz/v_q/ivqPackage/uid_typeHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.1"
* from /home/new/SuSe/ihs/vq.idl
* niedziela, 30 pa¼dziernik 2005 11:30:52 CET
*/

abstract public class uid_typeHelper
{
  private static String  _id = "IDL:vq/ivq/uid_type:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (com.foo_baz.v_q.ivqPackage.uid_typeHelper.id (), "uid_type", __typeCode);
    }
    return __typeCode;
  }
